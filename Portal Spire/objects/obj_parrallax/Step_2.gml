...
layer_x("Backgrounds_still1", ((bg_still1xoffset + _cam_x) - clamp((_cam_x * (0.15 * (960 / room_width))), 0, (sprite_get_width(background_layer_sprite_get("Backgrounds_still1")) - 960))))
layer_y("Backgrounds_still1", ((bg_still1yoffset + _cam_y) - clamp((_cam_y * (0.15 * (540 / room_height))), 0, (sprite_get_height(background_layer_sprite_get("Backgrounds_still1")) - 540))))
layer_x("Backgrounds_still2", ((bg_still2xoffset + _cam_x) - clamp((_cam_x * (0.25 * (960 / room_width))), 0, (sprite_get_width(background_layer_sprite_get("Backgrounds_still1")) - 960))))
layer_y("Backgrounds_still2", ((bg_still2yoffset + _cam_y) - clamp((_cam_y * (0.25 * (540 / room_height))), 0, (sprite_get_height(background_layer_sprite_get("Backgrounds_still1")) - 540))))
layer_x("Backgrounds_stillscroll", (((bg_still1xoffset + bg_scrollx) + _cam_x) - clamp((_cam_x * (0.15 * (960 / room_width))), 0, (sprite_get_width(background_layer_sprite_get("Backgrounds_stillscroll")) - 960))))
layer_y("Backgrounds_stillscroll", (((bg_still1yoffset + bg_scrolly) + _cam_y) - clamp((_cam_y * (0.15 * (540 / room_height))), 0, (sprite_get_height(background_layer_sprite_get("Backgrounds_stillscroll")) - 540))))
layer_x("Backgrounds_stillH1", (bg_stillH1xoffset + (_cam_x * 0.25)))
layer_y("Backgrounds_stillH1", (bg_stillH1yoffset + (_cam_y - clamp((_cam_y * (0.15 * (540 / room_height))), 0, (sprite_get_height(background_layer_sprite_get("Backgrounds_stillH1")) - 540)))))
layer_x("Backgrounds_stillH2", (bg_stillH2xoffset + (_cam_x * 0.25)))
layer_y("Backgrounds_stillH2", (bg_stillH2yoffset + (_cam_y - clamp((_cam_y * (0.15 * (540 / room_height))), 0, (sprite_get_height(background_layer_sprite_get("Backgrounds_stillH2")) - 540)))))
