...
if (prevstate != state)
{
	if (prevstate == (211 << 0) && prevsprite != spr_player_corpsestart && prevsprite != spr_player_corpsesurf)
...
if ((!grounded) && (state == (187 << 0) || state == (92 << 0) || state == (103 << 0) || state == (104 << 0) || state == (121 << 0)) && key_jump && global.noisejetpack == 1)
{
    vsp = -14
    state = (254 << 0)
...
if (blur_effect > 0)
    blur_effect--
else if (breakdance_speed >= 0.6 || mach4mode == 1 || boxxeddash == 1 || state == (16 << 0) || state == (5 << 0) || state == (198 << 0) || state == (193 << 0) || state == (42 << 0) || state == (116 << 0) || (state == (79 << 0) && sprite_index == spr_swingding && swingdingdash <= 0) || (state == (80 << 0) && (sprite_index == spr_player_breakdanceuppercut || sprite_index == spr_player_breakdanceuppercutend)) || state == (108 << 0) || state == (43 << 0))
{
...
if (object_index == obj_player1)
{
	...
	if !global.qolchanges
	{
		...
		if (!((state == (112 << 0) || state == (90 << 0) ||state == (150 << 0) || state == (119 << 0) || state == (46 << 0) || state == (98 << 0) || state == (46 << 0) || state == (146 << 0) || state == (95 << 0) || (state == (47 << 0) && (sprite_index == spr_knightpepstart || sprite_index == spr_knightpepthunder)) || instance_exists(obj_fadeout) || place_meeting(x, y, obj_secretportal) || place_meeting(x, y, obj_secretportalstart))))
		{
			if (global.combotime > 0)
				global.combotime -= 0.15
		}
