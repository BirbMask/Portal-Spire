...
if (obj_player.state != (89 << 0))
{
	...
	var t = (spr_h * perc)
	var top = (spr_h - t)
	draw_sprite_ext(global.rank == "norank" ? spr_ranks_hudgrape : spr_ranks_hud, rank_ix, rx, ry, rank_scale, rank_scale, 0, c_white, 1)
	draw_sprite_part(global.rank == "norank" ? spr_ranks_hudfillgrape : spr_ranks_hudfill, rank_ix, 0, top, spr_w, (spr_h - top), (rx - spr_xo), ((ry - spr_yo) + top))
